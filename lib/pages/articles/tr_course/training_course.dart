...
import 'package:news_app/pages/upload/courses/page1.dart';
...
class TrainingCourseArticles extends StatefulWidget {
  final String? category;
  final String? categoryImage;
  final String tag;

  TrainingCourseArticles(
      {Key? key,
  ...
  @override
  _TrainingCourseArticlesState createState() => _TrainingCourseArticlesState();
}

class _TrainingCourseArticlesState extends State<TrainingCourseArticles> {
  ...
  Future<Null> _getData() async {
    ...
    if (_lastVisible == null)
      data = await firestore
          .collection(collectionName).where('isPublished',isEqualTo: true)
