...
import 'package:news_app/pages/upload/mix/upload_mix.dart';
...
class MixArticles extends StatefulWidget {
  ...
  @override
  _MixArticlesState createState() => _MixArticlesState();
}

class _MixArticlesState extends State<MixArticles> {
  final FirebaseFirestore firestore = FirebaseFirestore.instance;
  final String collectionName = 'mix';
    ...
    if (data.docs.length > 0) {
      ...
      if (mounted) {
        setState(() {
          ...
          _data = _snap.map((e) => MixModel.fromFireStore(e)).toList();
        });
      }
    } else {
      if (_lastVisible == null) {
